...
write.table(x = sim.info,file = "Output/simulation.500off.25_500_npar.sr1.combined.information.txt",append = F,quote = F,sep = "\t",row.names = F,col.names = T)
write.table(x = pool,file = "Output/estimation.500off.25_500_npar.sr1.combined.information.txt",append = F,quote = F,sep = "\t",row.names = F,col.names = T)
